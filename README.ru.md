...
| 📚 **RAG Индексатор и Просмотрщик** | Продвинутый разбиватель документов (chunker) и интерактивный визуальный каталог документов с глубоким полнотекстовым поиском и подсветкой совпадений. |
